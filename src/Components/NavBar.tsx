        ...
        <div className="font-[Lexend]">
            <nav className="flex justify-between p-3 text-white my-2">
              ...
              <ul className="hidden sm:flex items-center justify-between sm:w-5/12 md:w-4/12 lg:w-3/10 xl:w-2/10 2xl:w-2/12 me-3">
                  <li className="hover:scale-105 hover:text-blue-400"><Link to={'/'}>Home</Link></li>
                  <li className="hover:scale-105 hover:text-blue-400"><Link to={'my-projects'}>Projects</Link></li>
                  <li onClick={scrollToBottom}><button className="cursor-pointer p-1.5 rounded-xl text-black bg-white hover:text-blue-400 hover:bg-transparent border border-transparent hover:border-white">Contact Me</button></li>
              </ul>
              <button 
