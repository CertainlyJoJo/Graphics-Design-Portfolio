...
function Footer() {
    ...
    return (
      <>
          <div className={`bg-[#494949]/15 rounded-4xl mx-5 my-5 py-5 ] font-[Lexend] ${triggerGlow ? "shadow-[0px_0px_20px_5px_rgba(255,255,255,0.8)]": "shadow-[0px_10px_20px_rgba(0,0,0,0.8)]"}`}>
