          ...
          <div className={`bg-zinc-600/30 rounded-4xl mx-7 my-5 py-5 font-[Lexend] ${triggerGlow ? "animate-[breathing_2s_ease-in-out]": ""} shadow-[0px_10px_20px_rgba(0,0,0,0.8)]`}>
              ...
              <div className='text-white place-self-center my-3'>
                  <div className='flex gap-9 sm:gap-12 2xl:gap-20 place-content-center place-items-center'>
                      <a href='https://github.com/CertainlyJoJo' target='_blank' className='h-auto w-1/12 sm:w-1/9'><img className='hover:scale-105' src="/github-mark-white.svg" alt="Github Profile" /></a>
                      <a href='https://www.instagram.com/certainly.jojo/' target='_blank' className='h-auto w-1/10 sm:w-1/7'><img className='hover:scale-105' src="/icons8-instagram.svg" alt="Instagram Profile" /></a>
                <a href='https://www.linkedin.com/in/joseph-ramdeholl/' target='_blank' className='h-auto w-1/10 sm:w-1/7'><img className='hover:scale-105' src="/linkedin.svg" alt="Linkedin Profile" /></a>
                  </div>
              </div>
              <div className='text-white text-xs place-self-center w-4/6 text-center mt-3 border-t pt-3 mx-auto'>
                  <p className="opacity-50 hover:opacity-100">Made by myself using React, Tailwind CSS and Framer Motion</p>
              </div>
          </div>
      </>
    )
